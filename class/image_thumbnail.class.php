<?php
// $Id: image_thumbnail.class.php,v 1.1 2005/02/11 21:14:37 andrew Exp $
//  ------------------------------------------------------------------------ //
//  Author: Andrew Mills                                                     //
//  Email:  ajmills@sirium.net                                               //
//	About:                                                                   //
//  Copyright:  Copyright © 2003-2005 Andrew Mills.                          //
//                                                                           //
//  ------------------------------------------------------------------------ //
...
// generate image thumbnaols

class thumbnails {

	function create($photopath, $thumbnailpath, $filename, $thumbwidth="180") {
		//$error = 0;
		...
		$gdinfo = gd_info();
		if (($imagesize['mime'] == "image/gif") AND ($gdinfo['GIF Read Support'])) {
